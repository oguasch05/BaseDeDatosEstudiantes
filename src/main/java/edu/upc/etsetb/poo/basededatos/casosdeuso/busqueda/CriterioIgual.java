...
/**
 * Clase que implementa el criterio "igual", en el que que la propiedad de una
...
public class CriterioIgual extends Criterio {
     ...
     * <code>criterio</code> ha de tener un valor IGUAL al de la propiedad
     * <code>valorAComprobar</code>.
     *
     * <p>
    ...
    public boolean esCumplido(FilaDatos f) {
        try {
        return f.get(nombreClave).toLowerCase().equals(valorAComprobar.toLowerCase());

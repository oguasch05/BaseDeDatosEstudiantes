...
public class CriterioMayorQueTest extends SuperClassForTests {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "CriterioMayorQue");
        nota.put("CriterioMayorQue", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_Constructor() {
        ...
        try {
            this.printlnAlways("\n\tCriterioMayorQue::CriterioMayorQue(nombreClave,valorAComprobar). Valor: " + valorTotal);
    ...
    public void test02_esCumplido() {
        ...
        double puntosAntes = puntosTotales;
        int numTests = 3;
        this.printlnAlways("\n\tCriterioMayorQueTest::esCumplido(filaDatos). Valor: " + valorTotal);
        try {
            ...
            instance = new CriterioMayorQue(nombreClave, "23");

...
public class CriterioContieneTest extends SuperClassForTests {
    ...
    public static void tearDownClass() {
        showErrors(indErrors, "CriterioContiene");
        nota.put("CriterioContiene", puntosTotales);
        puntosTotales = 0;
    }
    ...
    public void test01_Constructor() {
        ...
        try {
            this.printlnAlways("\n\tCriterioContieneTest::CriterioContieneTest(nombreClave,valorAComprobar). Valor: " + valorTotal);
            double individualPer = valorTotal / numTests;
            String nombreClave = "nombreClave-1";
            String valorAComprobar = "valor-1";            
            CriterioContiene instance = new CriterioContiene(nombreClave, valorAComprobar);
    ...
    public void test02_esCumplido() {
        ...
        double puntosAntes = puntosTotales;
        int numTests = 2;
        this.printlnAlways("\n\tCriterioContieneTest::esCumplido(filaDatos). Valor: " + valorTotal);
        try {
            FilaDatos fila = this.createFilaDatosValida();
            String nombreClave = "nombreClave-1";
            CriterioContiene instance = new CriterioContiene(nombreClave, "val");
            //
            this.printlnAlways("\tTest 1: comprobación cuando la fila de datos tiene "
                    + "mapeado con la clave un valor que contiene al valor a comprobar");
            error = this.sAssertTrue(instance.esCumplido(fila), 
                    valorTotal/numTests, "Error. La fila de datos tenía "
                            + "mapeado con la clave un valor que contiene al valor "
            ...
            this.printlnAlways("\tTest 2: comprobación cuando la fila de datos tiene "
                    + "mapeado con la clave un valor que NO contiene al valor a comprobar");
            instance = new CriterioContiene(nombreClave, "ve");
